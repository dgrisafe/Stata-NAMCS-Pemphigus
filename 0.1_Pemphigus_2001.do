*note:	This program works for NAMCS dataset for year 2000.
...
rename	(RACE	ETHNIC		PAYTYPE		REGION		OWNS)					///
		(RACER	RACERETH	PAYTYPER	REGIONOFF	OWNSR)
...
save pemphigus_namcs_2001, replace

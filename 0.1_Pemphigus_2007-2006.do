*note:	This program works for NAMCS datasets from years 2006 to 2007.
...
rename (REGION OWNS RACEETH PAYTYPE) (REGIONOFF OWNSR RACERETH PAYTYPER)
...
save pemphigus_namcs_2007, replace

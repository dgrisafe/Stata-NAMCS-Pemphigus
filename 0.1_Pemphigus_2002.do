*note:	This program works for NAMCS datasets for year 2002.
...
*			meds needed to be reformatted as numeric, in long type.
...
list patwt diag1 diag2 diag3 age sex race ethnic
...
keep 	year settype patwt 													///
		diag1 diag2 diag3 													///
		sex age ager race ethnic paytype region msa owns specr 				///
		med1-med6

*format med variables to numeric, then recast type as long to match standard format
destring(med1-med6), replace
recast long med1-med6
...
save pemphigus_namcs_2002, replace

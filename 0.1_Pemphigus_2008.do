*note:	This program works for NAMCS dataset for 2008.
...
keep 	YEAR SETTYPE PATWT 													///
		DIAG1 DIAG2 DIAG3 													///
		SEX AGE AGER RACER RACEETH PAYTYPER REGION MSA OWNS SPECR SPECCAT	///
		MED1-MED8

*rename to REGIONOFF standard
rename (REGION OWNS RACEETH) (REGIONOFF OWNSR RACERETH)
...
save pemphigus_namcs_2008, replace
